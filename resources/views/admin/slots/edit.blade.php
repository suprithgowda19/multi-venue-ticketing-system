    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-md sm:rounded-lg p-6">
                ...
                <form action="{{ route('admin.slots.update', $slot->id) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    {{-- Slot Name --}}
                    <div>
                        <label class="block font-medium text-gray-700 dark:text-gray-300 mb-1">Slot Name</label>

                        <input type="time" name="start_time" value="{{ old('start_time', $slot->start_time) }}"
                            class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200"
                            required>
